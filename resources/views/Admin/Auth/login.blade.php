...
@section('content')
    <div class="row align-items-center h-100">
        <form action="{{ route('admin.do_login') }}" method="post" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
            @csrf
            ...
            <h1 class="h6 mb-3">تسجيل دخول المدير</h1>
            ...
            <div class="checkbox mb-3">
                <label>
                    <input type="checkbox" name="remember"> حفظ بيانات الدخول </label>
            </div>
